...
1. **Создайте аккаунт** на [Railway](https://railway.com?referralCode=UFUQhx)
   Примечание: Ссылка выше ведет на Railway по моей реферральной ссылке. Если зарегистрироваться по ней, получите не 5$ на счет при регистрации, а 20$. Мне потом тоже обещали что-то отчислять, но только если будут оплаты, т.ч. я на это особо не рассчитываю :-)
